...
export const isProviderDriverKind = (value: unknown): value is ProviderDriverKind =>
  Schema.is(ProviderDriverKind)(value);
...
export const providerDriverKindFromProviderKind = (provider: ProviderKind): ProviderDriverKind =>
  ProviderDriverKind.make(provider);

export const providerInstanceIdFromProviderKind = (provider: ProviderKind): ProviderInstanceId =>
