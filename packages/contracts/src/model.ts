...
export type CursorReasoning = (typeof CURSOR_REASONING_OPTIONS)[number];
...
export const OpenCodeModelOptions = Schema.Record(
  Schema.String,
  Schema.Union([TrimmedNonEmptyString, Schema.Boolean]),
);
 ...
 */
export const LegacyProviderOptionSelectionsObject = Schema.Record(
  Schema.String,
  Schema.Union([TrimmedNonEmptyString, Schema.Boolean]),
);
export type LegacyProviderOptionSelectionsObject = typeof LegacyProviderOptionSelectionsObject.Type;
