...
export const ClientSettingsSchema = Schema.Struct({
  ...
  diffRenderMarkdown: Schema.Boolean.pipe(Schema.withDecodingDefault(Effect.succeed(false))),
...
export const OpenCodeSettings = makeProviderSettingsSchema(
  {
    ...
    serverUrl: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        title: "Server URL",
        description: "Leave blank to let T3 Code Omarchy spawn the server when needed.",
        providerSettingsForm: {
...
export const ClientSettingsPatch = Schema.Struct({
  ...
  diffRenderMarkdown: Schema.optionalKey(Schema.Boolean),
