...
function makeTestLayer(state: {
  ...
  const gitManager: GitManagerShape = {
    ...
    mergeBranches: () => Effect.die("mergeBranches should not be called in this test"),
    abortMerge: () => Effect.die("abortMerge should not be called in this test"),
    repositoryContext: () => Effect.die("repositoryContext should not be called in this test"),
  };
    ...
    const testLayer = GitStatusBroadcasterLive.pipe(
      Layer.provide(
        Layer.succeed(GitManager, {
          ...
          abortMerge: () => Effect.die("abortMerge should not be called in this test"),
          repositoryContext: () =>
            Effect.die("repositoryContext should not be called in this test"),
